...
// motor groups
pros::MotorGroup leftMotors({1}, pros::MotorGearset::blue); // left motor group - ports 3 (reversed), 4, 5 (reversed)
pros::MotorGroup rightMotors({2}, pros::MotorGearset::blue); // right motor group - ports 6, 7, 9 (reversed)
...
lemlib::ControllerSettings angularController(12.25, // proportional gain (kP)
                                             0, // integral gain (kI)
                                             1.8046, // derivative gain (kD)
                                             3, // anti windup
...
//For pure pursuit, not covered in Robospark curriculum, but is a very useful feature of LemLib
ASSET(example_txt);
